...
var (
	...
	fd_RegisterCoinProposal_override_existing_bank_metadata protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_RegisterCoinProposal_override_existing_bank_metadata = md_RegisterCoinProposal.Fields().ByName("override_existing_bank_metadata")
}
...
func (x *fastReflection_RegisterCoinProposal) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.OverrideExistingBankMetadata != false {
		value := protoreflect.ValueOfBool(x.OverrideExistingBankMetadata)
		if !f(fd_RegisterCoinProposal_override_existing_bank_metadata, value) {
			return
		}
	}
}
...
func (x *fastReflection_RegisterCoinProposal) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "evmos.erc20.v1.RegisterCoinProposal.override_existing_bank_metadata":
		return x.OverrideExistingBankMetadata != false
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_RegisterCoinProposal) Clear(fd protoreflect.FieldDescriptor) {
	...
	case "evmos.erc20.v1.RegisterCoinProposal.metadata":
		x.Metadata = nil
	case "evmos.erc20.v1.RegisterCoinProposal.override_existing_bank_metadata":
		x.OverrideExistingBankMetadata = false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: evmos.erc20.v1.RegisterCoinProposal"))
		}
...
func (x *fastReflection_RegisterCoinProposal) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "evmos.erc20.v1.RegisterCoinProposal.override_existing_bank_metadata":
		value := x.OverrideExistingBankMetadata
		return protoreflect.ValueOfBool(value)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: evmos.erc20.v1.RegisterCoinProposal"))
...
func (x *fastReflection_RegisterCoinProposal) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "evmos.erc20.v1.RegisterCoinProposal.metadata":
		...
		x.Metadata = *clv.list
	case "evmos.erc20.v1.RegisterCoinProposal.override_existing_bank_metadata":
		x.OverrideExistingBankMetadata = value.Bool()
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: evmos.erc20.v1.RegisterCoinProposal"))
		}
...
func (x *fastReflection_RegisterCoinProposal) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "evmos.erc20.v1.RegisterCoinProposal.override_existing_bank_metadata":
		panic(fmt.Errorf("field override_existing_bank_metadata of message evmos.erc20.v1.RegisterCoinProposal is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: evmos.erc20.v1.RegisterCoinProposal"))
		}
...
func (x *fastReflection_RegisterCoinProposal) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.OverrideExistingBankMetadata {
			n += 2
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field OverrideExistingBankMetadata", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.OverrideExistingBankMetadata = bool(v != 0)
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
				if err != nil {
...
func (x *RegisterCoinProposal) GetOverrideExistingBankMetadata() bool {
	if x != nil {
		return x.OverrideExistingBankMetadata
	}
	return false
}
...
var file_evmos_erc20_v1_erc20_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x72, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xdc, 0x01, 0x0a, 0x14, 0x52, 0x65,
	...
	0x00, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x45, 0x0a, 0x1f, 0x6f,
	0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x5f, 0x65, 0x78, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67,
	0x5f, 0x62, 0x61, 0x6e, 0x6b, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x1c, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x45, 0x78,
	0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x42, 0x61, 0x6e, 0x6b, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0x7d, 0x0a, 0x15, 0x52, 0x65, 0x67, 0x69,
	...
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0x53, 0x0a, 0x10,
	...
	0x61, 0x2a, 0x4a, 0x0a, 0x05, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x12, 0x15, 0x0a, 0x11, 0x4f, 0x57,
	...
	0x45, 0x52, 0x4e, 0x41, 0x4c, 0x10, 0x02, 0x1a, 0x04, 0x88, 0xa3, 0x1e, 0x00, 0x42, 0xa3, 0x01,
	0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x65, 0x76, 0x6d, 0x6f, 0x73, 0x2e, 0x65, 0x72, 0x63, 0x32,
	...
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x65, 0x76, 0x6d, 0x6f, 0x73, 0x2f, 0x65, 0x72, 0x63, 0x32, 0x30,
	0x2f, 0x76, 0x31, 0x3b, 0x65, 0x72, 0x63, 0x32, 0x30, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x45, 0x45,
	0x58, 0xaa, 0x02, 0x0e, 0x45, 0x76, 0x6d, 0x6f, 0x73, 0x2e, 0x45, 0x72, 0x63, 0x32, 0x30, 0x2e,
	0x56, 0x31, 0xca, 0x02, 0x0e, 0x45, 0x76, 0x6d, 0x6f, 0x73, 0x5c, 0x45, 0x72, 0x63, 0x32, 0x30,
	0x5c, 0x56, 0x31, 0xe2, 0x02, 0x1a, 0x45, 0x76, 0x6d, 0x6f, 0x73, 0x5c, 0x45, 0x72, 0x63, 0x32,
	0x30, 0x5c, 0x56, 0x31, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0xea, 0x02, 0x10, 0x45, 0x76, 0x6d, 0x6f, 0x73, 0x3a, 0x3a, 0x45, 0x72, 0x63, 0x32, 0x30, 0x3a,
