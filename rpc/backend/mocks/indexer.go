...
func (_m *EVMTxIndexer) GetByBlockAndIndex(_a0 int64, _a1 int32) (*evertypes.TxResult, error) {
	...
	var r0 *evertypes.TxResult
	var r1 error
	if rf, ok := ret.Get(0).(func(int64, int32) (*evertypes.TxResult, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(int64, int32) *evertypes.TxResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*evertypes.TxResult)
		}
	}
...
func (_m *EVMTxIndexer) GetByTxHash(_a0 common.Hash) (*evertypes.TxResult, error) {
	...
	var r0 *evertypes.TxResult
	var r1 error
	if rf, ok := ret.Get(0).(func(common.Hash) (*evertypes.TxResult, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(common.Hash) *evertypes.TxResult); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*evertypes.TxResult)
...
func (_m *EVMTxIndexer) IndexBlock(_a0 *cometbfttypes.Block, _a1 []*abci.ExecTxResult) error {
	ret := _m.Called(_a0, _a1)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*cometbfttypes.Block, []*abci.ExecTxResult) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
