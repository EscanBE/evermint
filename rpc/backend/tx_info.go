...
func (b *Backend) GetTransactionByHash(txHash common.Hash) (*rpctypes.RPCTransaction, error) {
	...
	block, err := b.CometBFTBlockByNumber(rpctypes.BlockNumber(res.Height))
	if err != nil {
		return nil, err
	}
...
func (b *Backend) GetTransactionReceipt(hash common.Hash) (*rpctypes.RPCReceipt, error) {
	...
	resBlock, err := b.CometBFTBlockByNumber(rpctypes.BlockNumber(res.Height))
	if err != nil {
		b.logger.Debug("block not found", "height", res.Height, "error", err.Error())
		return nil, nil
	}
	blockRes, err := b.CometBFTBlockResultByNumber(&res.Height)
	if err != nil {
