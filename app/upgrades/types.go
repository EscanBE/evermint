...
type Upgrade struct {
	// Upgrade version name, for the upgrade handler, e.g. `v13`
	UpgradeName string
...
type Fork struct {
	...
	UpgradeName string
	// UpgradeHeight is the height that upgrade occurs at
	UpgradeHeight int64
	// UpgradeInfo is the additional information for the upgrade
	UpgradeInfo string
