...
func TestConsumeSignatureVerificationGas(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:        args{storetypes.NewInfiniteGasMeter(), nil, ethsecKey.PubKey(), params},
			gasConsumed: ante.Secp256k1VerifyCost,
			shouldErr:   false,
		},
		{
		...
		},
		{
			...
			args:        args{storetypes.NewInfiniteGasMeter(), nil, skR1.PubKey(), params},
			gasConsumed: p.SigVerifyCostSecp256r1(),
			shouldErr:   true,
		},
		{
			name:        "pass - Multisig",
			args:        args{storetypes.NewInfiniteGasMeter(), multisignature1, multisigKey1, params},
			gasConsumed: expectedCost1,
			shouldErr:   false,
		},
		{
