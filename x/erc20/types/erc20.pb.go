...
type RegisterCoinProposal struct {
	...
	// override_existing_bank_metadata is a flag to force override existing bank metadata if any,
	// introduced since IBC v8 integrated as it automatically creates the bank denom metadata upon receive packet
	OverrideExistingBankMetadata bool `protobuf:"varint,4,opt,name=override_existing_bank_metadata,json=overrideExistingBankMetadata,proto3" json:"override_existing_bank_metadata,omitempty"`
}
...
func (m *RegisterCoinProposal) GetOverrideExistingBankMetadata() bool {
	if m != nil {
		return m.OverrideExistingBankMetadata
	}
	return false
}
...
var fileDescriptor_668d5dc537f45142 = []byte{
	...
	,
}
...
func (m *RegisterCoinProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.OverrideExistingBankMetadata {
		i--
		if m.OverrideExistingBankMetadata {
			dAtA[i] = 1
		} else {
...
func (m *RegisterCoinProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OverrideExistingBankMetadata", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OverrideExistingBankMetadata = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipErc20(dAtA[iNdEx:])
			if err != nil {
