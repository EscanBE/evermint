...
func NewMsgConvertCoin(coin sdk.Coin, receiver, sender sdk.AccAddress) *MsgConvertCoin { //nolint: interfacer
...
func NewMsgConvertERC20(amount sdkmath.Int, receiver sdk.AccAddress, contract common.Address, sender sdk.AccAddress) *MsgConvertERC20 { //nolint: interfacer
