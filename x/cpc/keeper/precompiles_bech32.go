...
// DeployBech32CustomPrecompiledContract deploys a new bech32 custom precompiled contract.
func (k Keeper) DeployBech32CustomPrecompiledContract(ctx sdk.Context) (common.Address, error) {
	contractAddress := cpctypes.CpcBech32FixedAddress

	// deployment
	contractMeta := cpctypes.CustomPrecompiledContractMeta{
		Address:               contractAddress.Bytes(),
		CustomPrecompiledType: cpctypes.CpcTypeBech32,
		Name:                  "Bech32 - Precompiled Contract",
		TypedMeta:             cpctypes.EmptyTypedMeta,
		Disabled:              false,
	}
...
func NewBech32CustomPrecompiledContract(
	metadata cpctypes.CustomPrecompiledContractMeta,
...
func (m bech32CustomPrecompiledContract) GetMetadata() cpctypes.CustomPrecompiledContractMeta {
	return m.metadata
}
