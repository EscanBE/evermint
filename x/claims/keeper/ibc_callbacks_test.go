...
func (suite *KeeperTestSuite) TestAckknowledgementPacket() {
	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				addr, err := sdk.AccAddressFromBech32("europa1x2w87cvt5mqjncav4lxy8yfreynn273xwx3ey6")
				suite.Require().NoError(err)

				mockpacket.Data = transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "europa1x2w87cvt5mqjncav4lxy8yfreynn273xwx3ey6",
...
func (suite *KeeperTestSuite) TestOnRecvPacket() {
	...
	senderStr := "europa1sv9m0g7ycejwr3s369km58h5qe7xj77h32xttx"
	receiverStr := "europa1hf0468jjpe6m6vx38s97z2qqe8ldu0njskfj6z"
	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData(constants.BaseDenom, "100", secpAddrCosmos, secpAddrEuropa, "")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
