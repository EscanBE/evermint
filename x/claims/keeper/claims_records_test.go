...
func (suite *KeeperTestSuite) TestsClaimsRecords() {
	addr1, err := sdk.AccAddressFromBech32("europa1hf0468jjpe6m6vx38s97z2qqe8ldu0njskfj6z")
	suite.Require().NoError(err)
	addr2, err := sdk.AccAddressFromBech32("europa1sv9m0g7ycejwr3s369km58h5qe7xj77h32xttx")
	suite.Require().NoError(err)
